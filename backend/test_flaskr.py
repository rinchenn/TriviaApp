...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.new_question = {'questions': 'Which continent Bhutan is in?',
                             'answer': 'Asia',
                             'category': 3,
                             'difficulty': 1}
    ...
    def test_delete_question(self):
        ...
        self.assertEqual(res.status_code, 200)
        self.assertEqual(data['success'], True)
        self.assertEqual(data['delete_question_id'], 27)
    ...
    def test_405_if_question_creation_now_allowed(self):
    ...
    def test_get_question_search_without_results(self):
        res = self.client().post('/search/questions', json={'searchTerm': 'walton'})
        data = json.loads(res.data)
    ...
    def test_play_quiz(self):
        # data = {'previous_questions': '17', 'quiz_category': {'id': 1, 'type': 'Science'}}
